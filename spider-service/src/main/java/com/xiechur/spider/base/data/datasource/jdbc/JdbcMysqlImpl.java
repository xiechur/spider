...
import com.xiechur.spider.base.data.datasource.jdbc.builder.SqlBuilder;
...
public class JdbcMysqlImpl extends JdbcDaoSupport implements Jdbc {
	...
	public JdbcMysqlImpl(JdbcTemplate jdbcTemplate) {
	...
	@Override
	public boolean updateForBoolean(UpdateBuilder builder) {
